...
par_direct:
	$(MAKE) m=gcp dsub_direct \
		...
		GCP_DSUB_DIRECT_IDIR_VARS='$(PAR_DIRECT_IDIR_VARS)' \
		GCP_DSUB_DIRECT_IDIR_BUCKETS='$(PAR_DIRECT_IDIR_BUCKETS)' \
		GCP_DSUB_DIRECT_IDIR_BASEDIRS='$(PAR_DIRECT_IDIR_BASEDIRS)' \
...
par_direct_local:
	...
	docker run -it --rm \
		...
		$(PAR_GCR_IMAGE_PATH) \
		$(PAR_DIRECT_COMMAND)
ifneq ($(PAR_DIRECT_OFN_VARS),NA)
	$(foreach o,$(PAR_DIRECT_OFN_VARS),mkdir -p $(dir $($o)); cp /tmp/$o $($o);)
endif
ifneq ($(PAR_DIRECT_ODIR_VARS),NA)
	$(foreach o,$(PAR_DIRECT_ODIR_VARS),mkdir -p $($o); cp -r /tmp/$o/* $($o)/;)
endif
